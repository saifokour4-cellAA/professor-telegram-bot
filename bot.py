...
READY_SUBJECTS = {
    ...
    ("تسويق صيدلي", "ميد"): (
        "📈 متوقع البروفيسور – تسويق صيدلي ميد\n\n"
        "القناة تحتوي على:\n"
        "✔ أسئلة متوقعة للامتحان\n"
        "✔ شرح كل سؤال بطريقة واضحة ومركزة\n"
        "✔ مراجعة للأفكار المهمة\n"
        "✔ تثبيت النقاط التي يكثر السؤال عنها\n\n"
        "💰 سعر الاشتراك: 6 دنانير\n\n"
        "💳 الدفع عبر زين كاش:\n"
        "📱 0798024692\n\n"
        "📸 بعد التحويل اضغط الزر بالأسفل وابعت صورة الوصل للبروفيسور."
    ),
    ("لاب علوم صيدلانية", "ميد"): (
        "🧪 متوقع البروفيسور – لاب علوم صيدلانية ميد\n\n"
        "القناة تحتوي على:\n"
        "✔ أسئلة متوقعة\n"
        "✔ شرح كل سؤال بشكل واضح ومباشر\n"
        "✔ ربط الأفكار ببعضها حتى تثبت المادة بدماغك\n"
        "✔ تغطية ذكية للأفكار المهمة في الامتحان\n"
        "✔ مستحيل تيجيك فكرة بالامتحان خارج إطار الأفكار الموجودة هون بإذن الله\n\n"
        "💰 سعر الاشتراك: 7 دنانير\n\n"
        "💳 الدفع عبر زين كاش:\n"
        "📱 0798024692\n\n"
        "📸 بعد التحويل اضغط الزر بالأسفل وابعت صورة الوصل للبروفيسور."
    ),
    ("لاب تراكيب 1", "ميد"): (
        "🧪 متوقع البروفيسور – لاب تراكيب 1 ميد\n\n"
        "القناة تحتوي على:\n"
        "✔ أسئلة متوقعة\n"
        "✔ شرح كل سؤال بشكل واضح ومباشر\n"
        "✔ ربط الأفكار ببعضها حتى تثبت المادة بدماغك\n"
